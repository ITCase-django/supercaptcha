...
BACKGROUND_COLOR = getattr(settings,
...
DEFAULT_ERROR_MESSAGE = getattr(settings,
...
HTML_TEMPLATE = getattr(
    ...
    'supercaptcha/captcha_html_template.html')

HTML_TEMPLATE_WITH_REFRESH = getattr(
    settings,
    'CAPTCHA_HTML_TEMPLATE_WITH_REFRESH',
    'supercaptcha/captcha_html_template_refresh.html')
